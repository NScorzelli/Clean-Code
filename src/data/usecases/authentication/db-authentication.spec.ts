...
import { AuthenticationModel, LoadAccountByEmailRepository, AccountModel, HashComparer, TokenGenerator, UpdateAccessTokenRepository } from './db-authentication-protocols'
...
const makeSut = (): SutTypes => {
  ...
  const sut = new DbAuthentication(loadAccountByEmailRepositoryStub, updateAccessTokenRepositoryStub, tokenGeneratorStub, hashComparerStub)
